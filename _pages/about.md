...
# 🔥 News / 最新动态
- **[2026.08]** Submitted a first-author paper on Quantum Prototype Classification. / 一作身份向投递量子原型分类文章 [[arXiv]](https://arxiv.org/abs/2608.10464)。
- **[2026.01]** Joined the Institute for AI Industry Research, Tsinghua University (THU AIR) as a research intern, focusing on brain-inspired Deep Research Agents. / 参加清华air冬令营，参与类脑认知 DeepResearch 智能体相关工作。
- **[2026.01]** Submitted a first-author paper on Quantum Multimodal Fusion Networks. / 一作身份向投递量子多模态融合网络文章 [[arXiv]](https://arxiv.org/abs/2601.07856)。
...
- **[2025.07]** Participated in the Tsinghua-PKU CLS-McGovern-CIDR Summer School (Best Team Award) and joined THU THBI, manuscript submitted for *ICML(2026)* . / 清华-北大神经与认知科学暑期班获最佳团队，并进入清华大学脑与智能实验室实习，工作在投 [[arXiv]](https://arxiv.org/abs/2602.19138)。
...
- **Second Prize**, National Student Computer System Capability Challenge (NSCSCC 2025)<br> *<small>“龙芯杯”全国大学生计算机系统能力培养大赛个人赛 **二等奖**</small>* [[Code]](https://github.com/Woodie-W/nscscc2025_grs_048) `2025`
...
- 第二届西北工业大学大学生国际理论力学竞赛校赛个人赛 **三等奖** `2024`
- 第四届西北工业大学大学生数学竞赛 **二等奖** `2023`
- 第十五届全国大学生数学竞赛陕西赛区 **二等奖** `2023`
</details>
